...
freechains --host=localhost:8400 chain accept / `freechains --host=localhost:8400 chain state list / rejected`
freechains --host=localhost:8401 chain accept / `freechains --host=localhost:8401 chain state list / rejected`
